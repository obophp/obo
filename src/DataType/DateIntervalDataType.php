...
class DateIntervalDataType extends \obo\DataType\Base\DataType {
    ...
    public static function dataTypeClass() {
        return \obo\Interfaces\IDataType::DATA_TYPE_CLASS_DATEINTERVAL;
    }
    ...
    public function validate($value, $throwException = true) {
        if ($value instanceof \DateInterval OR $value === null) return true;
