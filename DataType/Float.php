...
class Float extends \obo\DataType\Base\DataType {
    ...
    public function validate($value) {
        ...
        if (!\is_numeric($value) && !\is_float($value * 1) && $value !== "") throw new \obo\Exceptions\BadDataTypeException("Value for property with name '{$this->propertyInformation->name}' must be of float data type. Given value couldn't be converted.");
    }
