...
namespace obo\Tests\Servicies\EntitiesInformation\Information;
...
class CalculateSourcesChangesHashTest extends \Tester\TestCase {
    ...
    protected function createInformation($environmentVersion) {
        ...
        return new \obo\Tests\Services\EntityInformation\Information\Assets\EntitiesInformation\ExposedInformation($modelsDirs, \obo\obo::$entitiesExplorer, \obo\obo::$cache, $environmentVersion);
    }
